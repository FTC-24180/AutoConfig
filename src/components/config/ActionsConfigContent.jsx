        ...
        <div className="border border-gray-300 dark:border-slate-700 rounded-lg overflow-hidden">
          ...
          {isActionsExpanded && (
            <div className="p-4 pt-0">
                  ...
                  return (
                    <div key={`${action.id}-${originalIndex}`} className="bg-gray-50 dark:bg-slate-800 p-3 rounded-lg">
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border border-gray-300 dark:border-slate-600 dark:bg-slate-900 dark:text-gray-100 rounded-lg text-sm"
              ...
              <button
                onClick={() => onAddActionToGroup('actions', { label: 'New Action' })}
                className="w-full flex items-center justify-center gap-2 py-3 px-4 bg-green-600 active:bg-green-700 text-white rounded-lg font-semibold transition min-h-[48px] touch-manipulation"
              >
